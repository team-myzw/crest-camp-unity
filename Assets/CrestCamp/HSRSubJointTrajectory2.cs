...
{
	public class HSRSubJointTrajectory2 : MonoBehaviour, IHSRGraspedObjectHandler
	{
		...
		void Awake()
		{
			...
			this.trajectoryInfoMap.Add(HSRCommon.BaseFootPrintName, null);
...
//				Debug.Log("Duration="+ duration);
				...
				if (name == HSRCommon.BaseFootPrintName)
				{
					//this.trajectoryInfoMap[name] = new TrajectoryInfo(Time.time, duration, position, Time.time, HSRCommon.ge(this.handRProximalLink.localEulerAngles.x, name) * Mathf.Deg2Rad);
				}
			}
		}
